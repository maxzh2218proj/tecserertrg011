...
function ControlTester(){
    ...
    useEffect(() => {
        ...
        axios.get(`http://192.168.168.209:3001/controlotester/${id}`).then((response) => {
    ...
    const addControl = async (event) => {
        ...
        await axios
            .post("http://192.168.168.209:3001/controlotester", {
            ...
            await axios.get(`http://192.168.168.209:3001/controlotester/${id}`).then((response) => {
                setControls(response.data)
            });
    ...
    const deleteControl = (id) => {
        ...
        if(window.confirm("ВНИМАНИЕ!!! Вы подтверждаете удаление? ОТМЕНИТЬ НЕВОЗМОЖНО!!!")){
            ...
            axios.delete(`http://192.168.168.209:3001/controlotester/${id}`, {
    ...
    const handleEdit = (id) => {
        axios.get('http://192.168.168.209:3001/controlotester/'+id)
        .then((response) => {
      ...
      const handleUpdate = async () => {
        ...
        await axios.patch("http://192.168.168.209:3001/controlotester/"+editId, {id: editId, directionnum: udirectionnum, directionlink: udirectionlink, datedir: udatedir, opinionnum: uopinionnum, dateop: udateop, opinionlink: uopinionlink})
        .then(res => {
          console.log(res)
      ...
      const controlUpdate1 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/controlotester/directionlinkupdatetester/${editId}`, formData, {
            headers: {
      ...
      const controlUpdate2 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/controlotester/opinionlinkupdatetester/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const deleteDirection = async (directionId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/controlotester/directionlinkupdatetester/${directionId}`).then(response => {
                alert('Архив удалён');
            })
        }catch(error){
            console.log(error)
      ...
      const deleteOpinion = async (opinionId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/controlotester/opinionlinkupdatetester/${opinionId}`).then(response => {
                alert('Архив удалён');
            })
        }catch(error){
            console.log(error)
