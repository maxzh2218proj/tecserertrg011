              ...
              <div className="listOfGoods">
                  <table border={1} width="100%">
                      ...
                      {goods.map((usr, i) => (
                              ...
                              :
                              <tr key={i}>
                                  <td className="productlink" onClick={() => {history(`/materialseditorotk/${usr.id}`);}}>{usr.productname}</td>
                                  ...
                                  <td onClick={() => {history(`/controlotk/${usr.id}`);}} className="control">Перейти</td>
                                  <td>
