...
function GoodsTester(){
    ...
    const addGood = async (event) => {
        ...
        await axios
            .post("http://192.168.168.209:3001/goodstester", {
            ...
            await axios.get(`http://192.168.168.209:3001/clientstester/byId/${id}`).then((response) => {
                setClientObject(response.data)
            });
    
            await axios.get(`http://192.168.168.209:3001/goodstester/${id}`).then((response) => {
                setGoods(response.data)
            });
    ...
    const handleEdit = (id) => {
        axios.get('http://192.168.168.209:3001/goodstester/'+id)
        .then((response) => {
      ...
      const handleUpdate1 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/he/${editId}`, formData, {
            headers: {
      ...
      const handleUpdate12 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/he2/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate5 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updateotherdocs/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate52 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updateotherdocs2/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate7 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatetechsol/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate72 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatetechsol2/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate8 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatevsrnm/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate82 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatevsrnm2/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate9 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatereppas/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const handleUpdate92 = async () => {
        ...
        await axios.patch(`http://192.168.168.209:3001/goodstester/updatereppas2/${editId}`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
      ...
      const deleteHeattreatment = async (heatId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/goodstester/he/${heatId}`).then(response => {
              alert('Архив удалён');
          })
        }catch(error){
            console.log(error)
      ...
      const deleteOthersdocs = async (otherId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/goodstester/updateotherdocs/${otherId}`).then(response => {
              alert('Архив удалён');
          })
        }catch(error){
            console.log(error)
      ...
      const deleteTechnicalsolution = async (techId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/goodstester/updatetechsol/${techId}`).then(response => {
              alert('Архив удалён');
          })
        }catch(error){
            console.log(error)
      ...
      const deleteVsrnm = async (vsnrmId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/goodstester/updatevsrnm/${vsnrmId}`).then(response => {
              alert('Архив удалён');
          })
        }catch(error){
            console.log(error)
      ...
      const deleteReportingpassport = async (reportId) => {
        ...
        try{
            await axios.delete(`http://192.168.168.209:3001/goodstester/updatereppas/${reportId}`).then(response => {
              alert('Архив удалён');
          })
        }catch(error){
            console.log(error)
                ...
                <div className="listOfGoods">
                    <table border={1} width="100%">
                        ...
                        {goods.map((usr, i) => (
                                ...
                                :
                                <tr key={i}>
                                    <td className="productlink" onClick={() => {history(`/materialstester/${usr.id}`);}}>{usr.productname}</td>
                                    ...
                                    <td onClick={() => {history(`/controltester/${usr.id}`);}} className="control">Перейти</td>
                                    <td>
