...
function MaterialsEditor(){
    ...
    const handleFileUpload = (event) => {
        ...
        axios
          .post(`http://192.168.168.209:3001/materials/${id}`, formData, {
            headers: {
                        ...
                        <tbody>
                            {materials.map((usr, i) => (
                                ...
                                <tr key={i}>
                                    ...
                                    <td>{usr.normorder}</td>
                                    <td>{usr.note}</td>
                                    <td><a href={"../Texserveroriginal/ПКИ/"+usr.pki} target="_blank">{usr.pki}</a></td>
                                    <td>{usr.account}</td>
                                    <td>{usr.datepay}</td>
                                    <td>{usr.supplier}</td>
                                    ...
                                    <td>{usr.datevk}</td>
                                    <td>{usr.dateotk}</td>
                                    <td><a href={"../Texserveroriginal/Сертификаты/"+usr.sertificate} target="_blank">{usr.sertificate}</a></td>
