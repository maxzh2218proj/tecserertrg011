...
//create main model
const Brands = db.Goods;
const Cont = db.Controls;
const Mat = db.materials;
...
const updateBrands = async (req, res) => {
  ...
  const storage = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Термообработка");
    },
  ...
  const storage2 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Гидравлическиеипытания(акты)");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage3 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/УЗК");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage4 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/РГД");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage5 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Прочиедокументы");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage6 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/ВИК");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage7 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Технологическиерешения");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage8 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/ВСНРМ");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage9 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Отчётныйпасп");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage10 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Направления");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage11 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Заключения");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage12 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/ПКИ");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
  ...
  const storage13 = multer.diskStorage({
    destination: (req, file, cb) => {
      cb(null, "../client/build/Texserveroriginal/Сертификаты");
    },
    filename: function (req, file, callback) {
      callback(null, file.originalname);
    },
